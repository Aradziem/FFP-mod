...
public:
	...
	int getNumPlanetInfos();
	std::vector<CvPlanetInfo*>& getPlanetInfo();
	CvPlanetInfo& getPlanetInfo(PlanetTypes ePlanetTypeNum);

	int getNumOrbitInfos();
	std::vector<CvOrbitInfo*>& getOrbitInfo();
	CvOrbitInfo& getOrbitInfo(OrbitTypes eOrbitTypeNum);

	int getNumPlanetSizeInfos();
	std::vector<CvPlanetSizeInfo*>& getPlanetSizeInfo();
	CvPlanetSizeInfo& getPlanetSizeInfo(PlanetSizes ePlanetSizeTypeNum);

	int getNumPlanetSizeArtTagTypeInfos();
	std::vector<CvPlanetSizeArtTagTypeInfo*>& getPlanetSizeArtTagTypeInfo();
	CvPlanetSizeArtTagTypeInfo& getPlanetSizeArtTagTypeInfo(int i);

	int getNumStarInfos();
	std::vector<CvStarInfo*>& getStarInfo();
	CvStarInfo& getStarInfo(StarTypes eStarTypeNum);
...
protected:
	...
	************************************************************************************************************************/
	...
	std::vector<CvPlanetInfo*> m_paPlanetInfo;
	std::vector<CvOrbitInfo*> m_paOrbitInfo;
	std::vector<CvPlanetSizeInfo*> m_paPlanetSizeInfo;
	std::vector<CvPlanetSizeArtTagTypeInfo*> m_paPlanetSizeArtTagTypeInfo;
	std::vector<CvStarInfo*> m_paStarInfo;
