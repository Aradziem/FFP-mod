...
//Added in Final Frontier SDK: TC01
	...
	bool isArtTagSizeDependent();
	CvString getPlanetSizeArtTag(PlanetSizes i);
//End of Final Frontier SDK
...
//Added in Final Frontier: TC01
	...
	CvString* m_pszPlaneSizeArtTags;
//End of Final Frontier
...
public:
	...
	int getNumStageArtDefineTags();
	int* getStageForArtDefineTag();
	CvString* getStageArtDefineTags();
...
protected:
	...
	//Aradziem
	int m_iNumStageArtDefineTags;
	int* m_piStageForArtDefineTag;
	CvString* m_pszStageArtDefineTags;
	//Aradziem end
};
...
//  class : CvPlanetInfo
//
//  DESC:	Planet data from  CIV4PlanetInfos.xml
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvPlanetInfo;
class CvPlanetInfo : public CvInfoBase
{
	//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	...
	//CvString getType();//probably should be int or special type
	CvString getName();
	CvString getDescription();
	CvString getCivilopedia();
	CvString getArtDefineTag() const;
	int getClass() const;

	bool isGasGiant() const;
	...
	int getHealthPerPop() const;
	int getHappinessPerPop() const;

	int getNumBaseFeatures() const;
	int getBaseFeature(int i);
...
protected:
	...
	//CvString m_szType;
	CvString m_szName;
	CvString m_szDescription;
	CvString m_szCivilopedia;
	CvString m_iArtDefineTag;
	int m_iClass;
	...
	int m_iHealthPerPop;
	int m_iHappinessPerPop;

	int m_iNumBaseFeatures;
	int* m_piBaseFeatures;
};
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
//  class : CvOrbitInfo
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvOrbitInfo;
class CvOrbitInfo : public CvInfoBase
{
	//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	CvOrbitInfo();
	...
	//CvString getType();//probably should be int or special type
	CvString getOrbitArtDefineTag() const;
	CvString getPlanetArtDefineTag() const;
	CvString getBuildingArtDefineTag() const;

	//---------------------------------------PROTECTED MEMBER VARIABLES---------------------------------
protected:
	//CvString m_szType;
	CvString m_iOrbitArtDefineTag;
	CvString m_iPlanettArtDefineTag;
	CvString m_iBuildingArtDefineTag;
};

class CvPlanetSizeInfo;
class CvPlanetSizeInfo : public CvInfoBase
{
	//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	CvPlanetSizeInfo();
	...
	//CvString getType();//probably should be int or special type
	CvString getName();
	CvString getDescripyion();
	CvString getCivilopedia();
	int getPopulation() const;
	CvString getPlanetSizeArtTag() const;

	//int getNumPlanetSizeArtTagTypes() const;
	//int* getPlanetSizeArtTagTypes();//i.e. category of art tag
	CvString getPlanetSizeArtTags(int i);//the art tag used for that size

	int getNumPlanetSizePopulationArtTagTypes() const;
	int* getPlanetSizePopulationForArtTags();//minimum population for that art tag (highest value below or equal to should be used)
	CvString* getPlanetSizePopulationArtTags();////art tag for that population
...
protected:
	...
	CvString m_szCivilopedia;
	int m_iPopulation;
	CvString m_iPlanetSizeArtTag;

	//int m_iNumPlanetSizeArtTagTypes;
	//int* m_piPlanetSizeArtTagTypes;//i.e. category of art tag
	CvString* m_piPlanetSizeArtTags;//the art tag used for that size

	int m_iNumPlanetSizePopulationArtTagTypes;
	int* m_piPlanetSizePopulationForArtTag;//minimum population for that art tag (highest value below or equal to should be used)
	CvString* m_piPlanetSizePopulationArtTags;//art tag for that population
};

class CvPlanetSizeArtTagTypeInfo;
class CvPlanetSizeArtTagTypeInfo : public CvInfoBase
{
	//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	CvPlanetSizeArtTagTypeInfo();
	virtual ~CvPlanetSizeArtTagTypeInfo();
...
class CvStarInfo;
class CvStarInfo : public CvInfoBase
{
	//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
	CvStarInfo();
