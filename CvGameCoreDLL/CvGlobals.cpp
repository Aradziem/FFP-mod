...
std::vector<CvPlanetInfo*>& CvGlobals::getPlanetInfo()
{
	return m_paPlanetInfo;
}

CvPlanetInfo& CvGlobals::getPlanetInfo(PlanetTypes ePlanetTypeNum)
{
	//FAssert(ePlanetTypeNum > -1); //not needed/messing up?
	FAssert(ePlanetTypeNum < m_paPlanetInfo.size());
	return *(m_paPlanetInfo[ePlanetTypeNum]);
}

int CvGlobals::getNumOrbitInfos()
{
	return (int)m_paOrbitInfo.size();
}

std::vector<CvOrbitInfo*>& CvGlobals::getOrbitInfo()
{
	return m_paOrbitInfo;
}

CvOrbitInfo& CvGlobals::getOrbitInfo(OrbitTypes eOrbitTypeNum)
{
	FAssert(eOrbitTypeNum > -1); //not needed/messing up?
	FAssert(eOrbitTypeNum < m_paOrbitInfo.size());
	return *(m_paOrbitInfo[eOrbitTypeNum]);
}
...
std::vector<CvPlanetSizeInfo*>& CvGlobals::getPlanetSizeInfo()
{
	return m_paPlanetSizeInfo;
}

CvPlanetSizeInfo& CvGlobals::getPlanetSizeInfo(PlanetSizes ePlanetSizesNum)
{
	//FAssert(ePlanetSizeTypeNum > -1); //not needed/messing up?
	FAssert(ePlanetSizesNum < m_paPlanetSizeInfo.size());
	return *(m_paPlanetSizeInfo[ePlanetSizesNum]);
}

int CvGlobals::getNumPlanetSizeArtTagTypeInfos()
{
	return (int)m_paPlanetSizeArtTagTypeInfo.size();
}

std::vector<CvPlanetSizeArtTagTypeInfo*>& CvGlobals::getPlanetSizeArtTagTypeInfo()
{
	return m_paPlanetSizeArtTagTypeInfo;
}

CvPlanetSizeArtTagTypeInfo& CvGlobals::getPlanetSizeArtTagTypeInfo(int ePlanetSizeArtTagTypeNum)
{
	//FAssert(ePlanetTypeNum > -1); //not needed/messing up?
	FAssert(ePlanetSizeArtTagTypeNum < m_paPlanetSizeArtTagTypeInfo.size());
	return *(m_paPlanetSizeArtTagTypeInfo[ePlanetSizeArtTagTypeNum]);
}

int CvGlobals::getNumStarInfos()
{
	return (int)m_paStarInfo.size();
}

std::vector<CvStarInfo*>& CvGlobals::getStarInfo()
{
	return m_paStarInfo;
}

CvStarInfo& CvGlobals::getStarInfo(StarTypes eStarTypeNum)
{
	//FAssert(ePlanetTypeNum > -1); //not needed/messing up?
	FAssert(eStarTypeNum < m_paStarInfo.size());
	return *(m_paStarInfo[eStarTypeNum]);
}
//Aradziem end
...
void CvGlobals::deleteInfoArrays()
{
	...
	deleteInfoArray(m_paPlanetInfo);
