...
public:
	...
	bool plunder();
	void updatePlunder(int iChange, bool bUpdatePlotGroups) const;
	...
	float getExperience() const;																											// Exposed to Python
	void setExperience(float iNewValue, int iMax = -1);																// Exposed to Python																				
	void changeExperience(float iChange, int iMax = -1, bool bFromCombat = false, bool bInBorders = false, bool bUpdateGlobal = false);// Exposed to Python
