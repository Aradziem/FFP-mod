...
//End of Final Frontier SDK
	...
	LoadGlobalClassInfo(GC.getPlanetSizeArtTagTypeInfo(), "CIV4PlanetSizeArtTagTypeInfos", "SolarSystem", "Civ4PlanetSizeArtTagTypeInfos/PlanetSizeArtTagTypeInfos/PlanetSizeArtTagTypeInfo", false);
	LoadGlobalClassInfo(GC.getPlanetSizeInfo(), "CIV4PlanetSizeInfos", "SolarSystem", "Civ4PlanetSizeInfos/PlanetSizeInfos/PlanetSizeInfo", false);
	LoadGlobalClassInfo(GC.getPlanetInfo(), "CIV4PlanetInfos", "SolarSystem", "Civ4PlanetInfos/PlanetInfos/PlanetInfo", false);
	LoadGlobalClassInfo(GC.getStarInfo(), "CIV4StarInfos", "SolarSystem", "Civ4StarInfos/StarInfos/StarInfo", false);
	//Added in Final Frontier SDK: TC01
...
bool CvXMLLoadUtility::LoadPostMenuGlobals()
{
	...
	LoadGlobalClassInfo(GC.getOrbitInfo(), "CIV4OrbitInfos", "SolarSystem", "Civ4OrbitInfos/OrbitInfos/OrbitInfo", false);
