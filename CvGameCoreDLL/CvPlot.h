...
/********************************************************************************/	
	...
	CvSolarSystem* getPlotSolarSystem() const;
	void setPlotSolarSystemID(int pNewValue);
	void setPlotSolarSystem(const CvSolarSystem* pNewValue);
...
protected:
	...
	int m_plotSolarSystem;//not assigned to owner
