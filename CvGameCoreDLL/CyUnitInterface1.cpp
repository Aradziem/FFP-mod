...
void CyUnitPythonInterface1(python::class_<CyUnit>& x)
{
	...
	x
		...
		.def("setExperience", &CyUnit::setExperience, "void (float iNewValue)")
		.def("changeExperience", &CyUnit::changeExperience, "void (float iChange, int iMax, bool bFromCombat, bool bInBorders, bool bUpdateGlobal)")
